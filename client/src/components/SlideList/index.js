        ...
        <Grid container justify='center' className={classes.container}>
            <Grid item xs={8}>
                <Grid container justify='space-between'>
                    <Grid container justify='space-between' className={classes.toolbar} item>
                        <Paper className={classes.paper} square>
                            <Tabs value={value} indicatorColor='primary' textColor='primary' onChange={handleCategoryChange} aria-label='slide-type' variant='scrollable' scrollButtons='on' >
                                <Tab label='All'/>
                        ...
                        <div className={classes.toolbarFilter}>
                            Sort by
                            <IconButton className={classes.filter} aria-label='filter' color='inherit' aria-controls='simple-menu' aria-haspopup='true' onClick={handleOrderbyOpen}>
                                <FilterIcon/>
                            </IconButton>
                            <Menu id='orderby' anchorEl={anchorElOrderby} keepMounted open={Boolean(anchorElOrderby)} onClose={handleOrderbyClose}>
                            ...
                            <IconButton aria-controls='simple-menu' aria-haspopup='true' onClick={handleAscdescOpen} aria-label='up-down' color='inherit'>
                                <UpDownIcon/>
                            </IconButton>
                            <Menu id='asc-desc' anchorEl={anchorElAscdesc} keepMounted open={Boolean(anchorElAscdesc)} onClose={handleAscdescClose}>
                                <MenuItem onClick={handleAscdescClose}><ArrowDropUpIcon className={classes.arrowUp} /></MenuItem>
                                <MenuItem onClick={handleAscdescClose}><ArrowDropUpIcon className={classes.arrowDown}/></MenuItem>
                            </Menu>
                        </div>
                    </Grid>
                </Grid>
                <Grid className='Slides-Container' container justify='space-between' spacing={3}>
